/**
 * Shared git graph model.
 *
 * This is the contract between the main process (which reads a real repository
 * and produces a `GitModel`) and the renderer (which lays it out and draws it).
 */
...
/**
 * Result of asking the main process to read a repository. Either a rendered
 * model, or a typed reason it could not be produced.
 */
